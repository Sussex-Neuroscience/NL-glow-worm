...
- **LED array:** custom 3D printed semicircular structure fitting up to 9 LEDs (![LED array scad](hardware/LED_line.scad); Figure 3A), placed around the trackball apparatus, X cm above the top of the ball.
